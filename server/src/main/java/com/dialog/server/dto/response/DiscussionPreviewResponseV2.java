...
public record DiscussionPreviewResponseV2(
        Long id,
    ...
    public static DiscussionPreviewResponseV2 fromOfflineDiscussion(OfflineDiscussion offlineDiscussion, ProfileImage profileImage, long commentCount) {
        CommonDiscussionInfo commonInfo = CommonDiscussionInfo.from(offlineDiscussion, profileImage, commentCount);

        return new DiscussionPreviewResponseV2(
    ...
    public static DiscussionPreviewResponseV2 fromOnlineDiscussion(OnlineDiscussion onlineDiscussion, ProfileImage profileImage, long commentCount) {
